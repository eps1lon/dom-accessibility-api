...
<details>
<summary>Report 146/234 passing for accname of which 36 are due `::before { content }` or equivalent, a few might be wrong tests, and several are pathological.</summary>
...
```bash
  web-platform-tests
    accname
      ...
      ✔ [expected 12 failures] name/comp_label.html
